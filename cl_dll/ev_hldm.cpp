...
void EV_FireGlock1(event_args_t* args)
{
	...
	EV_GetDefaultShellInfo(args, origin, velocity, ShellVelocity, ShellOrigin, forward, right, up, 22, -6, 5); // up is actually right and right is actually up.... thanks gaben...
