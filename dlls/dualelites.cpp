...
void CElite::PrimaryAttack()
{
	...
	Vector vecDir = m_pPlayer->FireBulletsPlayer(2, vecSrc, vecAiming, VECTOR_CONE_5DEGREES, 8192, BULLET_PLAYER_BUCKSHOT,
		1, 7, m_pPlayer->pev, m_pPlayer->random_seed);//14 dmg
...
void CElite::Reload()
{
	...
	DefaultReload(30, ELITE_RELOAD, 4.7);
}
